...
Core library functions for NS Dojo TypeScript scripts running with Node.js.

## Overview

This package provides common utilities used across all TypeScript scripts in the NS Dojo platform:
...
```typescript
import {Colors} from "@ns-dojo-scripts/lib";
...
```typescript
#!/usr/bin/env node
import {getPlatformRoot, logInfo, logSuccess} from "@ns-dojo-scripts/lib";
